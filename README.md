...
Программа осуществляет мониторинг слишком долго работающих процессов

Написанная на C# утилита, которая мониторит процессы Windows и "убивает" те процессы, которые работают слишком долго.
